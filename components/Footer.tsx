...
export default function Footer() {
  return (
    <footer className="site-footer">
      ...
      <div className="footer-links"><p>Explore</p><Link href="/projects">Projects</Link><Link href="/about">About</Link><Link href="/gallery">Gallery</Link><Link href="/contact">Contact</Link></div>
