...
export default function AboutPage() {
  return <PageFrame><main className="inner-page">
    ...
    <section className="about-image"><img src="/assets/build1.png" alt="Prarambh 51 entrance" /><p>We do not merely create buildings. We shape the threshold between architecture and everyday life.</p></section>
